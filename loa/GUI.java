...
class GUI extends TopLevel implements View, Reporter {
    ...
    GUI(String title) {
        ...
        addMenuButton("Game->Switch Black", this::switchBlack);
        addMenuButton("Game->Switch White", this::switchWhite);
    ...
    /** True if black player should be switched. */
    private boolean _manualBlack;

    /** True if white player should be switched. */
    private boolean _manualWhite;
